...
public class Railing_Node
{
	...
	static Railing_GameEnviron game;
	//Link to next node
	Railing_Node next;
	...
	public Railing_Node(int sx,int sy)
	{
		curr_startx=sx;
		curr_starty=sy;
	...
	public Railing_Node(int sx,int sy,int ex,int ey)
	{
	...
	public Railing_Node(int sx,int sy,int ex,int ey,int dir)
	{
		curr_startx=prev_startx=sx;
		curr_starty=prev_starty=sy;
		curr_endx=prev_endx=ex;
	...
	public static void move(Railing_Node n)
	{
		...
		if(n.dir==1)
		{
			if(n.curr_starty+10>=game.height)
			{
				n.curr_starty=40;
				n.curr_endy=n.curr_starty-length;
			}
		...
		if(n.dir==3)
		{
			if(n.curr_startx+12>=game.width)
			{
				n.curr_startx=10;
				n.curr_endx=n.curr_startx-length;
			}
	...
	private static void drawNext(Railing_Node n,int startx,int starty,int endx,int endy,int dir)
	{
		if(n==null)
			return;
	...
	////////For Tail///////
	public static void increment(Railing_Node n)
	{
		if(n.next==null)
		{
			Railing_Node link=new Railing_Node(n.prev_startx,n.prev_starty,n.prev_endx,n.prev_endy,n.dir);
			n.next=link;
			return;
		}
		increment(n.next);
	}
	public static void drawSnake(Railing_Node n)
	{
		if(n==null)
			return;
		game.gfx.setRenderingHints(game.antiAlias_OFF);
	...
	private static void drawBody(Railing_Node n)
	{
		if(n==null)
			return;
		game.gfx.drawLine(n.curr_startx,n.curr_starty,n.curr_endx,n.curr_endy);
	...
	public static void deleteSnake(Railing_Node n)
	{
		if(n==null)
			return;
	...
	public static boolean snakeCrash(Railing_Node head,Railing_Node body)
	{
